  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-10 flex flex-col md:flex-row gap-4 md:gap-6 text-white">
      <motion.div
        ...
        className="group w-full md:w-1/3 bg-[#252129] hover:bg-[#7e609b] transition-colors duration-300 rounded-2xl p-6 md:p-8 flex flex-col justify-between min-h-[250px] md:min-h-[400px]"
      >
      ...
      <motion.div
        ...
        className="group w-full md:w-2/3 bg-[#252129] hover:bg-[#c759d8] transition-colors duration-300 rounded-2xl p-6 md:p-8 flex flex-col justify-between min-h-[350px] md:min-h-[400px]"
      >
        <div className="flex justify-between items-center text-slate-400 group-hover:text-white transition-colors duration-300">
