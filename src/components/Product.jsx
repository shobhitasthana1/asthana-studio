...
const Product = ({ val, mover, count }) => {
  return (
    <div className="w-full text-white">
      <div onMouseEnter={()=>{mover(count)}} className="max-w-7xl h-80 mx-auto px-4 md:px-6 py-12 md:py-20 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-0 border-b border-slate-700 transition-colors duration-300 hover:bg-[#1a181c] rounded-xl">
